...
import com.example.demo.factorybean.DemoFactoryBean;
import com.example.demo.factorybean.FilterFactoryBean;
...
public class FilterConfig {
    ...
    @Bean("a")
    public DemoFactoryBean a() {
        DemoFactoryBean f = new DemoFactoryBean();
        String filters = "/ = user\n" +
                "/data/dim/** = user\n";
        Map<String, String> m = new HashMap<>();
        m.put("user","/data/dim/**");
